   ...
   @include('admin.navbar')
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Edit Shop's Payment</h2>   
                        <h5>Welcome Admin , Here You Can Edit Shop's Payment. </h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Edit Shop's Payment
                            <a href="{{route('showPayment')}}" class="btn btn-primary"
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 style="color: rgb(0, 94, 255)">Edit Payment</h3>
                                    <form role="form" method="POST" enctype="multipart/form-data"
                                    action="{{url('updatePayment',$payment->id)}}">
                                        @csrf
