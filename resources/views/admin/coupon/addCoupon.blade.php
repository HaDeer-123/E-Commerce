   ...
   @include('admin.navbar')
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Add Shop's Coupon</h2>   
                        <h5>Welcome Admin , Here You Can Add Shop's Coupon. </h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 style="color: rgb(0, 94, 255)">Add Coupon</h3>
                                    <form role="form" method="POST" action="{{url('insertCoupon')}}" 
                                    enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label>Coupon Code</label>
                                            <input class="form-control" name="code" placeholder="Enter Coupon Name"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Discount Percentage</label>
                                            <input class="form-control" name="discount_percentage"  placeholder="Enter Discount Percentage" />
                                        </div>

                                        <div class="form-group">
                                            <label>Date Valid From</label><br>
                                            <input type="date" class="form-control" name="valid_from"  placeholder="Enter Date Valid From" />
                                           
                                        </div>

                                        <div class="form-group">
                                            <label>Coupon Valid To</label><br>
                                            <input type="date" class="form-control" name="valid_to"  placeholder="Enter Date Valid To" />
