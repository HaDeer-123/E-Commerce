   ...
   @include('admin.navbar')
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Add Shop's Product</h2>   
                        <h5>Welcome Admin , Here You Can Add Shop's Product. </h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 style="color: rgb(0, 94, 255)">Add Product</h3>
                                    <form role="form" method="POST" action="{{url('insertProduct')}}" 
                                    enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="size" placeholder="Enter Product Name"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Product Price</label>
                                            <input class="form-control" name="price" placeholder="Enter Product Name"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Product Color</label>
                                            <input class="form-control" name="color" placeholder="Enter Product Name"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Stock Quantity</label>
                                            <input class="form-control" name="stock_quantity" placeholder="Enter Product Name"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Product Category</label><br>
                                            <select name="category_id" id="" class="form-control">
                                                <option value="" disabled="disabled" selected>Select Product Category</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="" class="form-control">
                                                <option value="" disabled="disabled" selected>Select Product Status</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="" cols="130" rows="10" placeholder="Enter Product Description"
