   ...
   @include('admin.navbar')
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Edit Shop's Product</h2>   
                        <h5>Welcome Admin , Here You Can Edit Shop's Product. </h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 style="color: rgb(0, 94, 255)">Edit Product</h3>
                                    <form role="form" method="POST" action="{{url('updateProduct',$product->id)}}" 
                                    enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="stock_quantity" value="{{$product->stock_quantity}}"  />
                                        </div>
