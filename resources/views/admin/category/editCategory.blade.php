   ...
   @include('admin.navbar')
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Edit Shop's Category</h2>   
                        <h5>Welcome Admin , Here You Can Edit Shop's Category. </h5>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 style="color: rgb(0, 94, 255)">Edit Category</h3>
                                    ...
                                    action="{{url('updateCategory',$category->id)}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="image" value="{{$category->name}}"  />
                                        </div>

                                        <div class="form-group">
                                            <label>Category Description</label><br>
                                            <textarea name="description" id="" cols="130" rows="10" 
